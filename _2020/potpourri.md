...
Markdown 不仅容易上手，而且应用非常广泛。实际上本课程的课堂笔记和其他资料都是使用 Markdown 编写的。点击 [这个链接](https://github.com/ocean-sudo/missing-semester-cn-llm/blob/master/_2020/potpourri.md) 可以看到本页面的原始 Markdown 内容。
